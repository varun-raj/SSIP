...
class ComplaintsControllerTest < ActionController::TestCase
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post :create, complaint: { complainttype_id: @complaint.complainttype_id, department_id: @complaint.department_id, description: @complaint.description, title: @complaint.title }
    end
  ...
  test "should update complaint" do
    patch :update, id: @complaint, complaint: { complainttype_id: @complaint.complainttype_id, department_id: @complaint.department_id, description: @complaint.description, title: @complaint.title }
    assert_redirected_to complaint_path(assigns(:complaint))
  end
